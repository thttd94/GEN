function fun_file_list(a) {
    $.post("/file_list?" + (new Date).getTime().toString(), JSON.stringify({
        ...
        var c, d, e, f, g, h, i, j;
        "/" == a.substring(0, 1) && (a = a.substring(1, a.length)), $("a").remove(".to-path"), $("div").remove(".mdui-toolbar-spacer"), $("div").remove(".path_new_file"), $("div").remove(".path_refurbish"), c = "", now_path = a, d = $('<a class="to-path mdui-ripple mdui-ripple-white mdui-hidden-xs mdui-text-color-white-text">Thư mục gốc</a>'), d.click(function() {
            fun_file_list("")
            ...
            mdui.prompt("Nhập tên script cần tạo (gồm cả đuôi file)", function(b) {
            ...
            }), e.append($('<i class="mdui-list-item-icon mdui-icon material-icons">&#xe2c7;</i>'), $('<div class="mdui-list-item-content">' + c.name + "</div>")), g = $('<ul class="mdui-menu" id="path-file' + i + '"></ul>'), m = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Đổi tên</a></li>'), m.click(function() {
                mdui.prompt("输入要Đổi tên的文件夹名字", function(b) {
            ...
            }), n = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Xóa</a></li>'), n.click(function() {
                mdui.dialog({
                    title: "选择是否Xóa文件夹",
                    content: "Xóa则不可逆转",
                    buttons: [{
            ...
            }), g = $('<ul class="mdui-menu" id="path-file' + i + '"></ul>'), o = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Tải file</a></li>'), o.click(function() {
                location.href = "/download_file?filename=" + encodeURI("/var/mobile/Media/1ferver/" + a + "/" + c.name)
            }), p = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Sửa</a></li>'), p.click(function() {
                $.jump("script_edit.html", {
                    file: a + "/" + c.name
                })
            }), m = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Đổi tên</a></li>'), m.click(function() {
                mdui.prompt("输入要Đổi tên的文件名字(包括拓展名)", function(b) {
                    $.post("/rename_file", JSON.stringify({
                        filename: a + "/" + c.name,
                        newfilename: a + "/" + b
                    }), function(b) {
            ...
            }), q = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Xóa</a></li>'), q.click(function() {
                mdui.dialog({
                    title: "选择是否Xóa文件",
                    content: "Xóa则不可逆转",
                    buttons: [{
            ...
            }), g.append(o, p, m, q), "lua" == c.name.split(".").pop().toLowerCase() && (r = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Mã hóa</a></li>'), r.on("click", function() {
                var b = c.name,
                    d = c.name.replace(/(.*\/)*([^.]+).*/gi, "$2") + ".xxt",
                    e = "<span>是否Mã hóa“" + b + "” script không?<br>Mã hóa后储存至同目录下“" + d + '”.</span><br><li class="mdui-list-item mdui-ripple"><div class="mdui-list-item-content"><div class="mdui-list-item-title">Giữ thông tin debug</div><div class="mdui-list-item-text mdui-list-item-one-line xxtouch-tip">允许在Mã hóa的脚本发生Chạy期Lỗi之Giờ抛出带有行及名字的Lỗi信息</div><div class="mdui-list-item-text mdui-list-item-two-line xxtouch-tip">注意：激活该选项Mã hóa后的脚本有潜在的被反编译风险</div></div><label class="mdui-switch"><input id="no_strip" type="checkbox"> <i class="mdui-switch-icon"></i></label></li>\n';
                mdui.dialog({
                    title: "是否Mã hóa此文件",
                    content: e,
                    buttons: [{
                        ...
                        onClick: function(c) {
                            $.post("/encript_file", JSON.stringify({
                                ...
                                2 == b.code ? mdui.alert("Script có lỗi cú pháp: " + b.detail) : mdui.snackbar({
                                    message: b.message
                                }), fun_file_list(a)
                            }, "json").error(function() {
                                mdui.snackbar({
            ...
            }), g.append(r)), "xui" == c.name.split(".").pop().toLowerCase() && (r = $('<li class="mdui-menu-item"><a href="javascript:;" class="mdui-ripple">Mã hóa</a></li>'), r.on("click", function() {
                var b = c.name,
                    d = c.name.replace(/(.*\/)*([^.]+).*/gi, "$2") + ".xuic",
                    e = "<span>是否Mã hóa“" + b + "” script giao diện không?<br>Mã hóa后储存至同目录下“" + d + "”.</span>\n";
                mdui.dialog({
                    title: "是否Mã hóa此文件",
                    content: e,
                    buttons: [{
...
$(document).ready(function() {
        ...
        e = function() {
            ...
            for (var a = 0; a < b.length; a++) switch (b[a].success) {
                case -1:
                    ...
                    break;
                case 0:
                    $("#update-display").append('<li class="mdui-list-item" style="height: 50px;"><i class="mdui-list-item-icon mdui-icon material-icons">&#xe14c;</i><div class="mdui-list-item-content"><div class="mdui-list-item-title">' + b[a].bfile.name + '</div><div class="mdui-list-item-text">Tải lên thất bại</div></div></li>');
                    break;
                case 1:
                    $("#update-display").append('<li class="mdui-list-item" style="height: 50px;"><i class="mdui-list-item-icon mdui-icon material-icons"><div class="mdui-spinner"></div></i><div class="mdui-list-item-content"><div class="mdui-list-item-title">' + b[a].bfile.name + '</div><div class="mdui-list-item-text">Đang chờ tải lên</div></div></li>');
                    break;
                case 2:
                    $("#update-display").append('<li class="mdui-list-item" style="height: 50px;"><i class="mdui-list-item-icon mdui-icon material-icons">&#xe2c6;</i><div class="mdui-list-item-content"><div class="mdui-list-item-title">' + b[a].bfile.name + '</div><div class="mdui-list-item-text">Đang tải lên</div></div></li>');
                    break;
                case 3:
                    $("#update-display").append('<li class="mdui-list-item" style="height: 50px;"><i class="mdui-list-item-icon mdui-icon material-icons">&#xe876;</i><div class="mdui-list-item-content"><div class="mdui-list-item-title">' + b[a].bfile.name + '</div><div class="mdui-list-item-text">Tải lên thành công</div></div></li>')
            }
            mdui.updateSpinners()
        }, f = !1, e(), g = function() {
            var a, d, h;
    ...
    $("#main-drawer a[href='./script_choose.html']").addClass("mdui-list-item-active"), a = function() {
        ...
        $.post("/launch_script_file", "", function(a) {
            2 == a.code ? mdui.alert("Script có lỗi cú pháp: " + a.detail) : mdui.snackbar({
                message: a.message
            })
        }, "json").error(function() {
            mdui.snackbar({
