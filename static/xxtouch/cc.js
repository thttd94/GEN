    ...
    $("#main-drawer a[href='./cc.html']").addClass("mdui-list-item-active"), e = "", f = "", g = !1, h = document.domain, i = new Array, new Array, k = function () {
        ...
        try {
            r.onopen = function () {
                s({
                    method: "search"
                }), $("#button_text").html("&#xe047;"), $("#run_cc").attr("mdui-tooltip", "{content: 'Dừng服务'}"), g = !0
