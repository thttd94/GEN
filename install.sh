...
[ -f "$SCRIPT_DIR/reverse_tunnel_config.json" ] && [ ! -f "$APP_DIR/reverse_tunnel_config.json" ] && cp "$SCRIPT_DIR/reverse_tunnel_config.json" "$APP_DIR/reverse_tunnel_config.json"
