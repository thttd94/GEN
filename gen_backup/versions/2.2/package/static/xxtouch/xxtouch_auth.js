    ...
    $("#main-drawer a[href='./xxtouch_auth.html']").addClass("mdui-list-item-active"), a = function() {
        ...
        if (b($("#auth-code").val())) {
            ...
            $.post("/bind_code", {
                ...
                switch (b.code) {
                    case 0:
                        $("#auth-code").val(""), e = "", f = b.data.expireDate - b.data.nowDate, f /= 3600, f >= 24 && (e = e + (f / 24).toString() + "天"), 0 != f % 24 && (e = e + (f % 24).toString() + "小Giờ"), c = "Gia hạn cấp quyền thành công", a();
                        break;
                    case 1:
                        c = "Gia hạn cấp quyền thất bại.";
                        break;
                    case -1:
                        c = "Gia hạn cấp quyền thất bại";
                        break;
