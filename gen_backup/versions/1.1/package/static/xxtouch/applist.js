            ...
            if (cfg.code == 0) {
                ...
                $.each(cfg.data, function(index, app) {
                    $("#app-list").append(
                        ...
                        app.name +
                        '"><div class="mdui-list-item-content"><div class="mdui-list-item-title"><strong>Tên ứng dụng</strong></div><div class="mdui-list-item-text mdui-list-item-one-line">' +
                        app.name +
                        '</div></div></li><li class="mdui-list-item mdui-ripple" mdui-tooltip="{content: \'点击复制\'}" data-clipboard-text="' +
                        app.bid +
                        '"><div class="mdui-list-item-content"><div class="mdui-list-item-title"><strong>Bundle ID</strong></div><div class="mdui-list-item-text mdui-list-item-one-line">' +
                        app.bid +
                        '</div></div></li><li class="mdui-list-item mdui-ripple" mdui-tooltip="{content: \'点击复制\'}" data-clipboard-text="' +
                        app.bundle_path +
                        '"><div class="mdui-list-item-content"><div class="mdui-list-item-title"><strong>Đường dẫn gói ứng dụng</strong></div><div class="mdui-list-item-text mdui-list-item-two-line" style="word-break:break-all;">' +
                        app.bundle_path +
                        '</div></div></li><li class="mdui-list-item mdui-ripple" mdui-tooltip="{content: \'点击复制\'}" data-clipboard-text="' +
                        app.data_path +
                        '"><div class="mdui-list-item-content"><div class="mdui-list-item-title"><strong>Đường dẫn dữ liệu ứng dụng</strong></div><div class="mdui-list-item-text mdui-list-item-two-line" style="word-break:break-all;">' +
                        app.data_path +
                        '</div></div></li></ul><div class="mdui-panel-item-actions"><button class="mdui-btn mdui-xxtouch-button mdui-ripple" onclick="clearapp(\'' +
                        app.bid +
                        "');\">Xóa dữ liệu ứng dụng</button></div></div></div>"
                    );
                });
            } else {
                mdui.snackbar({
